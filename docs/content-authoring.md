...
in-flight provider HTTP and does not replace prior `bank.ir.json`.
Delete/rename wait on the generate lock. Generate is limited to subjects in the wizard catalog. Hand-authored IR
